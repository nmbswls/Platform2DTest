...
public class MovingPlatform : MapFootHold
{
    ...
    public List<MovingPlatformPoint> PathElements;
    ...
    public virtual void MoveAlongThePath()
    {
        switch (AccelerationType)
        {
            ...
            case PossibleAccelerationType.AnimationCurve:
                ...
                float remappedDistance = 1 - MathUtils.Remap(_distanceToNextPoint, 0f, distanceBetweenPoints, 0f, 1f);
